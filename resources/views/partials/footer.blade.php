...
<script src="{{ asset('./libs/dropzone/dist/dropzone-min.js?1738448791') }}" defer></script>
<script src="{{ asset('./js/tabler.min.js?1738096684') }}" defer></script>
<script src="{{ asset('./js/demo.min.js?1738096684') }}" defer></script>