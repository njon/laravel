                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="tel" name="mobile_phone" class="form-control" data-mask="+3\0 0000000000" data-mask-visible="true" placeholder="+3\0 (000) 000-0000" autocomplete="off" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-5">
                                                        <label class="form-label">Email Address</label>
                                                        <input type="email" name="email_address" class="form-control" placeholder="example@email.com" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-5">
                                                        <label class="form-label">Business Address</label>
                                                        <input type="text" name="business_address" class="form-control" placeholder="Enter business address" required>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="mb-5">
